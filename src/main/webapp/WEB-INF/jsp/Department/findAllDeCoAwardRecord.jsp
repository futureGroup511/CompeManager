...
<script type="text/javascript">
	function gotoPage(pageNum){
		...
		window.location.href="department_findAllDeCoAwardRecord.action?&pageNum=" + pageNum;
}					
</script>
</body>
</html>
...
<form action="department_findAllDeCoAcCond">
按年度查询：      
<s:select label="按年度查询" name="year" list="years" listKey="id" listValue="name"  headerKey="0" headerValue="请选择年度" />
按奖项查询：      
<s:select label="按奖项查询" name="award" list="awardHieraychys" listKey="awardHie_id" listValue="awardHie_name" headerKey="0" headerValue="请选择奖项" />
按竞赛项目查询：
<s:select label="按竞赛项目查询" name="competiton" list="competitons" listKey="id" listValue="name"  headerKey="0" headerValue="请选择竞赛项目" />
