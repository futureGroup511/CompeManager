...
<script type="text/javascript">
	function gotoPage(pageNum){
		...
		window.location.href="awardRecord_noPassCheckAwardRecord.action?&pageNum=" + pageNum;
}					
</script>
</body>
</html>
