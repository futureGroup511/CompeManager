...
<body>
		...
		<div class="center-block" style="width:500px">
			...
			<s:elseif test="#request.page.beginPageIndex-1 >= 1">
				<li><a href="${pageContext.request.contextPath}/student_lookAward?currentPage=${request.page.beginPageIndex-1}"><span>&laquo;</span></a></li>				
			</s:elseif>
			...
			<s:elseif test="#request.page.beginPageIndex+1 <= #request.page.pageCount">
				<li><a href="${pageContext.request.contextPath}/student_lookAward?currentPage=${request.page.beginPageIndex+1}"><span>&raquo;</span></a></li>				
			</s:elseif>
