...
<body>
	...
	<div class="center-block" style="width:500px">
			...
			<s:elseif test="#request.ps.beginPageIndex-1 >= 1">
				<li><a href="${pageContext.request.contextPath}/awardhierar_findAll?currentPage=${ps.beginPageIndex-1}"><span>&laquo;</span></a></li>				
			</s:elseif>
			...
			<s:elseif test="#request.ps.beginPageIndex+1 <= #request.ps.pageCount">
				<li><a href="${pageContext.request.contextPath}/awardhierar_findAll?currentPage=${ps.beginPageIndex+1}"><span>&raquo;</span></a></li>				
			</s:elseif>
